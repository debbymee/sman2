          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
               <img src="<?php echo base_url(); ?>foto/guru/<?php echo $this->session->userdata('foto')?> " alt="..." class="img-circle profile_img">
              </div>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo base_url(); ?>index/logout"><i class="fa fa-bars pull-right"></i> Log Out</a></li>
              </ul>

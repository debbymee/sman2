...
<div class="row">
		 ...
		 <form action="<?php echo base_url(); ?>guru/update_presensi12" method ="post"  class="form-horizontal form-label-left"  >
            ...
            foreach($siswa as $data) { ?>
				<tr>
					...
					<td>
                        ...
                        <select name="jam_datang" class="form-control" value=" <?php echo $presensi->jam_datang ?>">
					...
					<td>
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-12">
                        <select name="jam_pulang" class="form-control" value=" <?php echo $presensi->jam_pulang?>">
